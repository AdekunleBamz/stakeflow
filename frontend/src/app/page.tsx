    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="text-center py-16 space-y-4">
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
          Mint exclusive NFTs for just <span className="font-semibold text-white">0.001 STX</span>, stake them, and earn <span className="font-semibold text-white">STF tokens</span> as rewards.
          The future of NFT staking on <span className="font-semibold text-purple-400">Stacks</span>.
        </p>
      </section>

      {!isConnected ? (
        <div className="card max-w-md mx-auto text-center animate-slide-in-right">
      ...
      {/* Stats Section */}
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="card text-center hover:shadow-lg transition-all duration-300 border-dashed">
