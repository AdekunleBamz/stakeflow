  ...
  const features = [
    {
      ...
      title: "Low Mint Price",
      description: "Mint StakeFlow NFTs for just 0.001 STX each. Accessible to everyone.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Stake your NFTs immediately after minting and start earning rewards.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Earn ~14.4 STF tokens per day for each staked NFT. Rewards accumulate automatically.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Built on Stacks with Clarity smart contracts. Fully auditable and trustless.",
    },
  ];
